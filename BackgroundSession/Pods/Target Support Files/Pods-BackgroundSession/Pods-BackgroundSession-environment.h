...
// PonyHttpUrl
#define COCOAPODS_POD_AVAILABLE_PonyHttpUrl
#define COCOAPODS_VERSION_MAJOR_PonyHttpUrl 0
#define COCOAPODS_VERSION_MINOR_PonyHttpUrl 0
#define COCOAPODS_VERSION_PATCH_PonyHttpUrl 4
